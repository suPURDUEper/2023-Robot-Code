...
public interface VisionIO {
  ...
  public static class VisionIOInputs implements LoggableInputs {
    ...
    public void fromLog(LogTable table) {
      table.put("VisionUpdate/Pose", new double[] {visionUpdate.pose().getX(), visionUpdate.pose().getY(), visionUpdate.pose().getRotation().getRadians()});
    ...
    public void toLog(LogTable table) {
      ...
      double[] visionMeasurements = table.getDoubleArray("VisionUpdate/Pose", new double[] {visionUpdate.pose().getX(), visionUpdate.pose().getY(), visionUpdate.pose().getRotation().getRadians()});
      Pose2d visionPose = new Pose2d(visionMeasurements[0], visionMeasurements[1], Rotation2d.fromRadians(visionMeasurements[2]));
