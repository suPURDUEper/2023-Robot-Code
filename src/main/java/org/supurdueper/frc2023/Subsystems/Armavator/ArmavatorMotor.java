...
public class ArmavatorMotor {
    ...
    new LoggedTunableNumber("Arm/Motor/Kp");
    private static final LoggedTunableNumber armKd = 
    new LoggedTunableNumber("Arm/Motor/Kd");
    private static final LoggedTunableNumber armKs =
    new LoggedTunableNumber("Arm/Motor/Ks");
    private static final LoggedTunableNumber armKv = 
    new LoggedTunableNumber("Arm/Motor/Kv");
