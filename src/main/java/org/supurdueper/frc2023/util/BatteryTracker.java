...
import org.supurdueper.frc2023.Constants.Swerve.RobotType;
...
public class BatteryTracker {
  ...
  public static String scanBattery(double timeout) {
    if (Constants.Swerve.getMode() == Constants.Swerve.Mode.REAL) {
      if (supportedRobots.contains(Constants.Swerve.getRobot())) {
